 ...
 * @author RYZEN
 */
public class ControllerCitasCRUD {
    
    private ModeloPrincipal modelo;
    private PanelCitasCRUD vistaUsuario;
    private VistaDashboard vistaDashboard;
    

    public ControllerCitasCRUD(ModeloPrincipal modelo, PanelCitasCRUD vista, VistaDashboard dashboard) {
        this.modelo = modelo;
